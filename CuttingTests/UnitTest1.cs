...
namespace CuttingTests
{
    ...
    public class CalcTests
    {
        ...
        {
            var material1 = new Product("1");
            var materialBatch1 = new Batch("te1", material1, 80, 2, 0, DateTime.Today, "plavka1");
            var materialBatch2 = new Batch("te2", material1, 80, 4, 0, DateTime.Today, "plavka1");
            List<Batch> materialBatches = new() { materialBatch1, materialBatch2 };

            var product = new Product("det2", "path1", 2, 1, material1.id) { billet_len = 1 };
            var productBatch1 = new Batch("batch1", product, 80, 6, 0, new DateTime(2021, 12, 2)) { auto_start = 1 };
            //var productBatch2 = new Batch("batch2", product, 80, 10, 0, new DateTime(2021, 12, 1));
